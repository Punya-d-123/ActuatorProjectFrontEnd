...
export default function ActuatorSizing({ setActiveTab, dashboardData }) {
  ...
  return (
    <div className="p-4 bg-gray-100 text-[12px] font-sans min-h-screen h-screen overflow-hidden items-center justify-center">
      {/* Top row: Valve Info + Actuator Selector */}
      <div className="flex gap-3 mb-3">
        {/* Valve Information */}
        <div className="bg-white p-4 rounded-lg shadow-lg w-full max-w-[460px] md:max-w-[420px] sm:max-w-[95%] flex flex-col items-center">
        ...
        <div className="bg-white p-4 shadow-lg rounded-lg w-[110vh]">
      ...
      <div className="flex gap-3">
        <div className="bg-white shadow-lg rounded-lg w-full max-w-[460px] md:max-w-[420px] sm:max-w-[95%] flex items-center justify-center">
